(function() {
    ...
    mt = {},
    c = {
        id: "de9dba15268b21741b9b8946830c9b65",
        dm: ["haogegebisai.com"],
    ...
    mt.o.Ia = function(a, b) {
        ...
        document.addEventListener ? g = function() {
            ...
            if (!e) if (e = s, "complete" === document.readyState) a.w = s;
            else if (document.addEventListener) document.addEventListener("DOMContentLoaded", g, w),
    ...
    mt.j.stringify = function() {
        ...
        return function(d) {
            ...
            default:
                ...
                n = ["{"];
                f = mt.j.stringify;
                for (k in d) if (Object.prototype.hasOwnProperty.call(d, k)) switch (l = d[k], typeof l) {
                case "undefined":
                case "unknown":
                case "function":
                    break;
    ...
    h.B = {
        ...
        f = {
            ...
            _trackRTEvent: function(b) {
                ...
                if (e.d(b, "Object")) {
                    ...
                    else for (var k = Math.ceil(k / 900), p = "block|" + Math.round(Math.random() * g.J).toString(16) + "|" + k + "|", q = [], u = 0; u < k; u++) q.push(u),
        ...
        a.prototype = {
            ...
            G: function() {
                ...
                b = 0,
                d = c.dm.length; b < d; b++) if (this.I(a, c.dm[b])) return c.dm[b].replace(/(:\d+)?[\/\?#].*/, "");
                return a
            },
            N: function() {
                for (var a = 0,
        ...
        if ("undefined" !== typeof h.b && (c.med || (!a.ua || 7 < a.sa) && c.cvcc)) {
            ...
            f = {
                click: function() {
                    for (var a = [], b = l(document.getElementsByTagName("a")), b = [].concat.apply(b, l(document.getElementsByTagName("area"))), b = [].concat.apply(b, l(document.getElementsByTagName("img"))), d, f, e = 0, g = b.length; e < g; e++) d = b[e],
            ...
            if ("undefined" !== typeof f && "undefined" !== typeof n) {
                ...
                k += /\/$/.test(k) ? "": "/";
                var u = function(a, d) {
                    if (q === d) return v(k + a, d),
                    w;
                    if (b.d(d, "Array") || b.d(d, "NodeList")) for (var e = 0,
                    f = d.length; e < f; e++) if (q === d[e]) return v(k + a + "/" + (e + 1), d[e]),
                    w
                };
        ...
        if ("undefined" !== typeof h.b && b.d(c.cvcf, "Array") && 0 < c.cvcf.length) {
            var g = {
                W: function() {
                    ...
                    d, f = 0; f < b; f++)(d = a.fa(decodeURIComponent(c.cvcf[f]))) && e.c(d, "click", g.ca())
                },
                ca: function() {
                    return function() {
                        h.b.a.et = 86;
